...
//    NSUserDefaults* _sharedUserDefaults = nil;
...
//    }
//    NSLog(@"%@", [_sharedUserDefaults objectForKey:StoredTextKey]);
//    NSLog(@"%ld", (long)[_sharedUserDefaults integerForKey:StoredNumKey]);
